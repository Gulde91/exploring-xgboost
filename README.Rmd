...
```{r na random plots}
p1 <- ggdraw() + draw_image("./results/sparse_vs_dense_random_na_roc_plot_10_percent.jpg", scale = 1.1)
p2 <- ggdraw() + draw_image("./results/sparse_vs_dense_random_na_roc_plot_20_percent.jpg", scale = 1.1)
p3 <- ggdraw() + draw_image("./results/sparse_vs_dense_random_na_roc_plot_30_percent.jpg", scale = 1.1)
p4 <- ggdraw() + draw_image("./results/sparse_vs_dense_random_na_roc_plot_40_percent.jpg", scale = 1.1)
